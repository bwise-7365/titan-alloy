...
int main(int argc, char** argv) {
    ...
    // Bundled OFL banner font (Marcellus, a Trajan-style Roman face). A missing or
    // unreadable font is surfaced as a warning rather than silently substituted;
    // the banner then falls back to the default UI font.
