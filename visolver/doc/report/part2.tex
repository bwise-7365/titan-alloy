...
actually decide. A programmatic \code{chooseEngine} dispatcher over these
same inputs (dimension, free-block size, PSD-ness, warm-start availability,
degeneracy proxies) is planned but not yet built; today the decision is the
caller's.
