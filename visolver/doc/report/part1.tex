...
\item \textbf{A flock of minimal problems} --- small instances built
  ...
  check exactly, and pin every engine and safeguard individually; 132
...
\addlinespace
Whole suite
  & \textbf{132 of 132 tests green}, spanning unit, protocol, and
    acceptance layers. \\
\bottomrule
\end{tabular}
...
and compositions shipped and documented, all 132 tests green, the three
