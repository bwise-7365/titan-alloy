...
\item \textbf{An engine dispatcher} --- automatic engine selection from
  problem features (size, structure, monotonicity, degeneracy proxies),
  mechanizing the decision table of Chapter~\ref{ch:manual}.
