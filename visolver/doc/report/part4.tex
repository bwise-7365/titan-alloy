...
effort and the pre-position-and-deploy family --- whose Nash equilibria are
posed directly as MCPs. The games arrive as GAMS models with verified
...
\subsection{Strategic allocation of effort}
\label{sec:a-saoe}
