...
// ----------------------------------------------
// Levenberg-Marquardt: building blocks and self-contained solver implementation.
// ----------------------------------------------
...
namespace VINCP {
  ...
  double
  levenbergMarquardtUpdate(double lambda, bool stepAccepted,
  ...
  VIResult
  levenbergMarquardtSolve(const VectorField& F,
                          const VectorXd& x0,
