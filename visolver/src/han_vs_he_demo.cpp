...
static void runLinearSize(Index N, std::mt19937& rng,
...
int main() {
    ...
    try {
        const VINCP::VIResult han = VINCP::solveVI(model, z0, innerHan, params);
        const VINCP::VIResult he  = VINCP::solveVI(model, z0, innerHe,  params);
